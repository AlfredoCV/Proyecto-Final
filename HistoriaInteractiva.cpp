																...
																do{
																	...
																	switch (eleccion){
																		...
																		case '3' :
																			vida = 0;
																			cout << "\t\t\t\t\t\t\t" << nombre << ' ' << vida << " HP" << endl;
																			cout << "A pesar de que ni sabias si el medicamento iba a funcionar era mejor intentarlo. Poco a poco has perdido el control de tu cuerpo y la capacidad de razonar... Te haz convertido en un zombie...";
																			break;
																		case '4' : 
																			cout << "Saliendo del programa...";
																			break;
